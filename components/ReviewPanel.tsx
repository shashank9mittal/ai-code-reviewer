...
import { ReviewResult, Severity, Annotation } from '../types/review'
...
const FIX_BUTTON_STYLE: Record<'critical' | 'warning', string> = {
  critical: 'border-[#ef4444] text-[#ef4444] hover:bg-[#ef4444]/10',
  warning: 'border-[#f59e0b] text-[#f59e0b] hover:bg-[#f59e0b]/10',
}
                      ...
                      {(annotation.severity === 'critical' ||
                        ...
                        <button
                          ...
                          className={`shrink-0 rounded border px-2 py-0.5 text-xs transition-colors ${
                            FIX_BUTTON_STYLE[annotation.severity]
                          }`}
                        >
                          Fix it
                        </button>
